...
if (isset($_POST["submitpnjm"])) {
    ...
    if (tambahdata($_POST) > 0) {
        ...
        document.location.href='formpeminjaman.php';
        </script>
        ";
    }
}
...
<head>
    ...
    <title>Form Peminjaman - Website Peminjaman - Universitas Teknokrat Indonesia</title>
                    ...
                    <div class="col-12 col-md-8 col-lg-12">
                        <div class="document-card">
                            <div class="d-flex justify-content-between flex-wrap ">
                                <div>
                                    <h2 class="content-title">Form Peminjaman</h2>
                            ...
                            <div class="content">
                                <form action="#" method="post">
                                    <div class="user-details">
                                        ...
                                        <div class="input-box">
                                            <span class="details">Masukkan Nama Peminjam </span>
                                            <input type="text" name="nama" placeholder="Masukkan Nama Peminjam" autocomplete="0" required>
                                        </div>
                                        <div class="input-box">
                                            <span class="details">Masukkan NPM </span>
                                            <input type="number" name="npm" placeholder="Masukkan NPM" autocomplete="0" required>
                                        </div>
                                        <div class="input-box">
                                            <span class="details">Masukkan Program Studi</span>
                                            <input type="text" name="prodi" placeholder="Masukkan Program Studi" autocomplete="0" required>
                                        </div>
                                        <div class="input-box">
                                            <span class="details">Masukkan ID Barang </span>
                                            <input type="number" name="id_brg" placeholder="Masukkan ID Barang" autocomplete="0" required>
                                        </div>
                                        <div class="input-box">
                                            <span class="details">Masukkan ID Ruangan </span>
                                            <input type="number" name="id_ruangan" placeholder="Masukkan ID Ruangan" autocomplete="0" required>
                                        </div>
                                        <div class="input-box">
                                            <span class="details">Nomor Telepon</span>
                                            <input type="number" name="no_tlp" placeholder="Masukkan Nomor Telepon" autocomplete="0" required>
                                        </div>
                                        <div class="input-box">
                                            <span class="details">Tanggal Pinjam</span>
                                            <input type="date" name="date" placeholder="Masukkan Tanggal Pinjam" autocomplete="0" required>
                                        </div>
                                        <div class="input-box">
                                            <label for="waktu">Waktu Pinjam</label>
                                            <select id="waktu" name="lama_pinjam" required>
                                                <option value="1 Hari">Pilih Waktu</option>
                                                <option value="Aula">1 Hari</option>
                                        ...
                                        <textarea id="keterangan" name="alasan" rows="4" required></textarea>
                                        <div class="button">
                                            <input type="reset" value="Reset">
                                        </div>
                                        <div class="button">
                                            <input type="submit" name="submitpnjm" value="Submit">
                                        </div>
                                    </div>
                                </form>
                            </div>
