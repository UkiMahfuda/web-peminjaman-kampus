...
<head>
    ...
    <title>Pengaturan Akun - Website Peminjaman - Universitas Teknokrat Indonesia</title>
                ...
                <div class="col-12 col-md-8 col-lg-12">
                    ...
                    <div class="statistics-card text-white" style="  background: #2e738f;">
                        ...
                        <h5 class="content-desc text-white">
                            Menu pengaturan akun dapat digunakan untuk memperbarui data pribadi pengguna.
                        </h5>
                        ...
                        <div class="document-card">
                            ...
                            <div class="content">
                                <form action="#" method="post">
                                    <!-- <input type="hidden" name="id" id="id" required value="<?php echo $update[0]["id"] ?>"> -->
                                    <div class="user-details">
                                        <div class="input-box">
                                            <span class="details">Nama</span>
                                            <input type="text" name="nama" placeholder="Masukkan Username" value="<?php echo $update[0]['nama'] ?>">
                                        </div>

                                        <div class=" input-box">
                                            <span class="details">Program Studi</span>
                                            <input type="text" name="prodi" placeholder="Masukkan Program Studi" value="<?php echo $update[0]['prodi'] ?>">
                                        </div>

                                        <div class=" input-box">
                                            <span class="details">NPM</span>
                                            <input type="number" name="npm" placeholder="Masukkan NPM" value="<?php echo $update[0]['npm'] ?>">
                                        </div>

                                        <div class=" input-box">
                                            <span class="details">Nomor Telepon</span>
                                            <input type="number" name="no_tlp" placeholder="Masukkan Nomor Telepon" value="<?php echo $update[0]['no_tlp'] ?>">
                                        </div>

                                        <label for=" alamat">Alamat:</label>
                                        <textarea id="alamat" name="alamat" rows="4" value="<?php echo $update[0]['alamat'] ?>"></textarea>
                                        <div class=" button">
